...
// Server Action to trigger search (legacy)
async function runSearch() {
  ...
  try {
    ...
    revalidatePath('/jobs')
    redirect(`/jobs?search=complete&t=${Date.now()}`)
  } catch (error) {
    ...
    revalidatePath('/jobs')
    redirect('/jobs?search=error')
  }
}

export default async function LegacyJobsDashboard({
  searchParams
}: {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6 bg-amber-50 border border-amber-200 rounded-lg p-4">
          <p className="text-amber-800 font-medium">
            ...
            <a href="/" className="underline hover:text-amber-900">Company Discovery</a>{' '}
